...
class Module{
    ...
    protected:
        ...
        //State machine keeping track of connection status, with discovery distinct for subclass implementation purposes
        enum ConnectionStates {DISCOVERY, DISCONNECTED, TRANSMITTING, SUSPECT};
        ConnectionStates status = DISCOVERY;
        ConnectionStates prev_status = DISCOVERY;
